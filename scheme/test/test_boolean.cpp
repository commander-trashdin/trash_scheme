...
TEST_F(SchemeTest, AndSyntax) {
  ...
  // remaining expressions are not evaluated. If all the expressions evaluate to
  // true values, the value of the last expression is returned. If there are no
...
TEST_F(SchemeTest, OrSyntax) {
  ...
  // false values, the value of the last expression is returned. If there are no
